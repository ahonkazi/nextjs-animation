...
const Menu = () => {
    ...
    return (
        <AnimatePresence>
            {
                themeContext.menuStatus && (
                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className='h-screen site-container z-[100] fixed flex-col top-0 left-0 w-full bg-white flex items-center justify-center'>
